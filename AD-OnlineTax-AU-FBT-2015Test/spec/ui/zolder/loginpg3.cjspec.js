...
describe('Tax online test', function () {
  ...
  it('tax online Client', function (done) {
    client
      .url(urltax)
  ...
  it('tax online Accounting', function (done) {
    client
  ...
  it('tax on line browse2', function (done) {
    client
      .url(urltax)
      .windowHandleMaximize()
      .click('a.pull-left')
      .pause(80000)
      .click('a[href="/tax/fbt"]')
      .getTitle(function(err, title) {
        console.log('Title was: ' + title);
        //assert(title === title2);
        return this.url();
 ...
 */
//css=a.pull-left
//<a href="/clients" ui-sref="clients.all" ng-class="{active: $state.includes('clients')}" class="global-nav-item"><i class="icon-clients" title="Clients"></i> Clients</a>
//'a[href="/plans"]'
...
//css=a.pull-left
/*
new Select(driver.findElement(By.id("client"))).selectByVisibleText("ABC Family Trust");
driver.findElement(By.cssSelector("option[value=\"0\"]")).click();
driver.findElement(By.id("return-due-date")).click();
driver.findElement(By.cssSelector("button.btn.btn-success")).click();
driver.findElement(By.id("input.ReportingParty.Identifiers.TaxFileNumber.Identifier")).clear();
driver.findElement(By.id("input.ReportingParty.Identifiers.TaxFileNumber.Identifier")).sendKeys("123456789");
driver.findElement(By.id("input.ReportingParty.Identifiers.AustralianBusinessNumber.Identifier")).click();
new Select(driver.findElement(By.xpath("//select"))).selectByVisibleText("Yes");
